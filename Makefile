...
debs:
	...
	cp deb/p* installer/farmbotProxy_1.0-1_amd64/DEBIAN/
	cp deb/control_amd64/* installer/farmbotProxy_1.0-1_amd64/DEBIAN/
	...
	cp deb/p* installer/farmbotProxy_1.0-1_i386/DEBIAN/
	cp deb/control_i386/* installer/farmbotProxy_1.0-1_i386/DEBIAN/
	...
	cp deb/p* installer/farmbotProxy_1.0-1_arm64/DEBIAN/
	cp deb/control_arm64/* installer/farmbotProxy_1.0-1_arm64/DEBIAN/
